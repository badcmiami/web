...
write('logo-mark-inverse.svg', svg(mark(navy='#FFFFFF', teal=TEAL, paper='#000B33')))
...
write('logo-lockup-inverse.svg', svg(lockup(navy='#FFFFFF', paper='#000B33'), w=1160, h=540))
...
{mark(navy='#FFFFFF', teal=TEAL, paper='#000B33')}
  </g>
